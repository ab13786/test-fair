            ...
            <section style="clear:both;">
                ...
                <?php
                    ...
                    if($results->num_rows>0){
                        ...
                        while($row = $results->fetch_assoc()){
                            echo "<tr><td>". $row['ParadeAppID']. "</td><td>". $row['ContactFN'] ." ". $row['ContactLN'] ."</td><td>". $row['PhoneNumber'] . "</td><td>". $row['Email'] . "</td><td>". $row['Address'] . "</td><td>". $row['State'] . "</td><td>". $row['City'] . "</td><td>". $row['Zip'] . "</td><td>". $row['GroupName'] . "</td><td>". $row['SponsorFN'] ." ". $row['SponsorLN'] . "</td><td>". $row['SponsorAddress'] . "</td><td>". $row['SponsorCity'] . "</td><td>". $row['SponsorState'] . "</td><td>". $row['SponsorZip'] . "</td><td>". $row['NumParticipant'] . "</td><td>". $row['Description'] . "</td><td>". $row['float'] . "</td><td>". $row['vehicle'] . "</td><td>". $row['band'] . "</td><td>". $row['theme'] . "</td></tr>";
                        }
                        echo "</table>";
                    }
