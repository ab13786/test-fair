                ...
                <?php
                    ...
                    if($results->num_rows>0){
                        ...
                        while($row = $results->fetch_assoc()){
                            echo "<tr><td>". $row['LegoAppID']. "</td><td>". $row['Builder1FN']. " ". $row['Builder1LN']. "</td><td>". $row['Builder2FN']. " ". $row['Builder2LN']. "</td><td>". $row['DOBBuilder1']. "</td><td>". $row['Address']. "</td><td>". $row['PhoneNumber']. "</td><td>". $row['Email']. "</td></tr>";
                        }
                        echo "</table>";
                    }
