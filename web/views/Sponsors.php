            ...
            <?php
                    ...
                    if($results->num_rows>0){
                        ...
                        while($row = $results->fetch_assoc()){
                            echo "<tr><td>". $row['SponsorID']. "</td><td>". $row['SponsorName']. "</td><td>". $row['SponsorTitle']. "</td><td><img src='data:image/png;base64," .base64_encode(stripslashes($row['SponsorLogo'])) .'></td></tr>";
                        }
                        echo "</table>";
                    }
